<x-admin-layout>
@vite(['resources/css/rougeStyleVueActualiteCrud.css', 'resources/js/app.js'])
<form class="needs-validation" action="{{ route('admin.actu.update',$fluxRss['id']) }}" method="POST">
    @csrf
    @method('put')
    <div class="form-row">
